/*
 * ========================================================= bootstrap-datepicker.js http://www.eyecon.ro/bootstrap-datepicker ========================================================= Copyright 2012 Stefan Petre
 * 
...
!function($) {
				...
				switch (target[0].nodeName.toLowerCase()) {
					case 'th' :
						switch (target[0].className) {
							...
							case 'prev' :
							case 'next' :
								this.viewDate['set' + DPGlobal.modes[this.viewMode].navFnc].call(this.viewDate, this.viewDate['get' + DPGlobal.modes[this.viewMode].navFnc].call(this.viewDate) + DPGlobal.modes[this.viewMode].navStep
	...
	DPGlobal.template = '<div class="datepicker dropdown-menu">' + '<div class="datepicker-days">' + '<table class=" table-condensed">' + DPGlobal.headTemplate + '<tbody></tbody>' + '</table>' + '</div>' + '<div class="datepicker-months">'
			+ '<table class="table-condensed">' + DPGlobal.headTemplate + DPGlobal.contTemplate + '</table>' + '</div>' + '<div class="datepicker-years">' + '<table class="table-condensed">' + DPGlobal.headTemplate + DPGlobal.contTemplate
			+ '</table>' + '</div>' + '</div>';
