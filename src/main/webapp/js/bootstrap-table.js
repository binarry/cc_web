...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = {
        ...
        formatShowingRows : function(pageFrom, pageTo, totalRows) {
            return '显示' + pageFrom + '到' + pageTo + '条 ' + '共'
                    + totalRows + '条记录'
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            ...
            '<li class="page-pre"><a href="javascript:void(0)">上一页</a></li>');
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.$body.find('> tr > td').off('click').on('click', function () {
            ...
            if (that.options.clickSelectedStyle && !that.options.clickToSelect) {
                $('.selected_row', $tr.parent()).removeClass('selected_row');// $tr.parent(),in case two or more tables on one page
