...
(function($) {
	...
	$.fn.panel.parseOptions = function(_68) {
		...
		return {
			id : t.attr("id"),
			width : (parseInt(_68.style.width) || undefined),
			height : (parseInt(_68.style.height) || undefined),
			left : (parseInt(_68.style.left) || undefined),
			top : (parseInt(_68.style.top) || undefined),
