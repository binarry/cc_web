...
(function($) {
	function _1(_2) {
		var _3 = $("<div class=\"slider\">" + "<div class=\"slider-inner\">" + "<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>" + "<span class=\"slider-tip\"></span>" + "</div>" + "<div class=\"slider-rule\"></div>"
				+ "<div class=\"slider-rulelabel\"></div>" + "<div style=\"clear:both\"></div>" + "<input type=\"hidden\" class=\"slider-value\">" + "</div>").insertAfter(_2);
			...
			for (var i = 0; i < aa.length; i++) {
				...
				if (aa[i] != "|") {
					...
					if (_d.mode == "h") {
						_13.css({
									left : _12,
									marginLeft : -Math.round(_13.outerWidth() / 2)
								});
					} else {
						_13.css({
									top : _12,
									marginTop : -Math.round(_13.outerHeight() / 2)
								});
					}
				}
			}
	...
	$.fn.slider.parseOptions = function(_37) {
		var t = $(_37);
		return {
			width : (parseInt(_37.style.width) || undefined),
			height : (parseInt(_37.style.height) || undefined),
