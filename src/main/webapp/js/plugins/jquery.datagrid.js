...
(function($) {
	...
	function _1a(_1b) {
		...
		if (_1d.length) {
			...
			msg.css({
						left : (_1c.width() - msg.outerWidth()) / 2,
						top : (_1c.height() - msg.outerHeight()) / 2
					});
		}
	};
	...
	function _2c(_2d, _2e) {
		...
		var _33 = $("<div class=\"datagrid-wrap\">" + "<div class=\"datagrid-view\">" + "<div class=\"datagrid-view1\">" + "<div class=\"datagrid-header\">" + "<div class=\"datagrid-header-inner\"></div>" + "</div>" + "<div class=\"datagrid-body\">"
				+ "<div class=\"datagrid-body-inner\"></div>" + "</div>" + "<div class=\"datagrid-footer\">" + "<div class=\"datagrid-footer-inner\"></div>" + "</div>" + "</div>" + "<div class=\"datagrid-view2\">" + "<div class=\"datagrid-header\">"
				+ "<div class=\"datagrid-header-inner\"></div>" + "</div>" + "<div class=\"datagrid-body\"></div>" + "<div class=\"datagrid-footer\">" + "<div class=\"datagrid-footer-inner\"></div>" + "</div>" + "</div>"
				+ "<div class=\"datagrid-resize-proxy\"></div>" + "</div>" + "</div>").insertAfter(_2d);
		_33.panel({
					doSize : false
				});
		...
		return {
			...
			dc : {
				...
				view1 : _3a,
				view2 : _3b,
				body1 : _3a.children("div.datagrid-body").children("div.datagrid-body-inner"),
				body2 : _3b.children("div.datagrid-body"),
				footer1 : _3a.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
				footer2 : _3b.children("div.datagrid-footer").children("div.datagrid-footer-inner")
			}
		};
	};
	function _3c(_3d) {
	...
	function _41(_42) {
		...
		_44.panel($.extend({}, _43, {
					id : null,
					doSize : false,
					onResize : function(_45, _46) {
						_1a(_42);
						setTimeout(function() {
			...
			if (typeof _43.toolbar == "string") {
				...
				for (var i = 0; i < _43.toolbar.length; i++) {
					...
					if (btn == "-") {
						...
						_4c.css("float", "left").appendTo(tb).linkbutton($.extend({}, btn, {
									plain : true
								}));
					}
				}
		...
		if (_43.pagination) {
			...
			_4d.pagination({
						pageNumber : _43.pageNumber,
						pageSize : _43.pageSize,
						pageList : _43.pageList,
					...
					$(this).resizable({
								...
								onStartResize : function(e) {
									...
									dc.view.children("div.datagrid-resize-proxy").css({
												left : e.pageX - $(_6b).offset().left - 1,
												display : "block"
											});
									_6f($(this), false);
								},
		...
		tr.children("td").each(function() {
					...
					if (col && col.editor) {
						...
						if (_fe) {
							...
							$.data(_fa[0], "datagrid.editor", {
										actions : _fe,
										target : _fe.init(_fa.find("td"), _fd),
										field : _fb,
										type : _fc,
										oldHtml : _ff
									});
		...
		return this.each(function() {
					...
					if (_132) {
						...
						opts = $.extend({}, $.extend({}, $.fn.datagrid.defaults, {
											queryParams : {}
										}), $.fn.datagrid.parseOptions(this), _130);
	...
	$.fn.datagrid.methods = {
		options : function(jq) {
			...
			var opts = $.extend(_179, {
						width : _17a.width,
						height : _17a.height,
						closed : _17a.closed,
						collapsed : _17a.collapsed,
						minimized : _17a.minimized,
						maximized : _17a.maximized
					});
			var _17b = jq.datagrid("getPager");
			if (_17b.length) {
				var _17c = _17b.pagination("options");
				$.extend(opts, {
							pageNumber : _17c.pageNumber,
							pageSize : _17c.pageSize
						});
			}
			return opts;
		},
	...
	$.fn.datagrid.parseOptions = function(_19b) {
		var t = $(_19b);
		return $.extend({}, $.fn.panel.parseOptions(_19b), {
	...
	var _19c = {
		render : function(_19d, _19e, _19f) {
	...
	$.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
				...
				editors : _134,
				finder : {
					getTr : function(_1c7, _1c8, type, _1c9) {
						type = type || "body";
						_1c9 = _1c9 || 0;
