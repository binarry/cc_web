	...
	function _1e(_1f, pos, _20) {
		...
		_1f.show(0, function() {
					...
					_1f[0].shadow.css({
								...
								left : _1f.css("left"),
								top : _1f.css("top"),
								width : _1f.outerWidth(),
								height : _1f.outerHeight()
							});
	...
	$.fn.menu = function(_3a, _3b) {
		...
		return this.each(function() {
					...
					if (_3c) {
						...
						_3c = $.data(this, "menu", {
									options : $.extend({}, $.fn.menu.defaults, _3a)
								});
						_1(this);
					}
					$(this).css({
								left : _3c.options.left,
								top : _3c.options.top
							});
				});
	};
	...
	$.fn.menu.methods = {
		...
		getItem : function(jq, _42) {
			var _43 = {
				target : _42,
				id : $(_42).attr("id"),
				text : $.trim($(_42).children("div.menu-text").html()),
				disabled : $(_42).hasClass("menu-item-disabled"),
				href : $(_42).attr("href"),
				onclick : _42.onclick
			};
