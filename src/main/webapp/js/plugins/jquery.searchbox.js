...
(function($) {
	...
	function _a(_b) {
		...
		function _f(_11) {
			...
			mb.prependTo(_c.searchbox).menubutton({
						menu : _c.menu,
						iconCls : _11.iconCls
					});
	...
	$.fn.searchbox = function(_1f, _20) {
		...
		return this.each(function() {
					...
					if (_21) {
						...
						_21 = $.data(this, "searchbox", {
									options : $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _1f),
									searchbox : _1(this)
								});
					}
					_a(this);
	...
	$.fn.searchbox.parseOptions = function(_27) {
		var t = $(_27);
		return {
			width : (parseInt(_27.style.width) || undefined),
