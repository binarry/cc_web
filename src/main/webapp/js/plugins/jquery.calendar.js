...
(function($) {
	...
	function _5(_6) {
		$(_6).addClass("calendar").wrapInner("<div class=\"calendar-header\">" + "<div class=\"calendar-prevmonth\"></div>" + "<div class=\"calendar-nextmonth\"></div>" + "<div class=\"calendar-prevyear\"></div>"
				+ "<div class=\"calendar-nextyear\"></div>" + "<div class=\"calendar-title\">" + "<span>Aprial 2010</span>" + "</div>" + "</div>" + "<div class=\"calendar-body\">" + "<div class=\"calendar-menu\">"
				+ "<div class=\"calendar-menu-year-inner\">" + "<span class=\"calendar-menu-prev\"></span>" + "<span><input class=\"calendar-menu-year\" type=\"text\"></input></span>" + "<span class=\"calendar-menu-next\"></span>" + "</div>"
	...
	$.fn.calendar = function(_38, _39) {
		...
		return this.each(function() {
					...
					if (_3a) {
						...
						_3a = $.data(this, "calendar", {
									options : $.extend({}, $.fn.calendar.defaults, $.fn.calendar.parseOptions(this), _38)
								});
						_5(this);
					}
	...
	$.fn.calendar.methods = {
		...
		moveTo : function(jq, _3d) {
			return jq.each(function() {
						$(this).calendar({
									year : _3d.getFullYear(),
									month : _3d.getMonth() + 1,
									current : _3d
								});
					});
		}
	...
	$.fn.calendar.parseOptions = function(_3e) {
		var t = $(_3e);
		return {
			width : (parseInt(_3e.style.width) || undefined),
			height : (parseInt(_3e.style.height) || undefined),
